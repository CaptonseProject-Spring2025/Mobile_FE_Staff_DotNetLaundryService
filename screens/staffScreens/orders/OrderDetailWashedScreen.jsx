          ...
          <ScrollView className="flex-1 p-4">
            ...
            <View className="mb-4">
              <TouchableOpacity
                ...
                className={`py-3 rounded-lg items-center justify-center ${isUploading ? 'bg-green-300' : 'bg-green-600'}`}
              >
                {isUploading ? (
                  <View className="flex-row items-center">
                  ...
                  <View className="flex-row items-center">
                    ...
                    <Text className="text-white font-bold ml-2">XÁC NHẬN KIỂM TRA CHẤT LƯỢNG</Text>
                  </View>
                )}
              </TouchableOpacity>
            </View>
